...
(
    id              bigint auto_increment primary key,
    username        varchar(50)                         not null comment 'For login purposes',
    firstName       text                                 null,
    lastName        text                                 null,
...
create index user_email_index       on user(deleted, email ASC);
create index user_username_index    on user(deleted, username ASC );